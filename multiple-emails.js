(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		if (settings.theme.toLowerCase() == "Bootstrap".toLowerCase())
		{
			...
			deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove" style="font-size:10px;">x</a>';
		}
		...
		return this.each(function() {
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left" placeholder="Assigned To" />').on('keyup', function(e) { // input
